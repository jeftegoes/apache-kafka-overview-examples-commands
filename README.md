...
- [17. An Evolution of data](#17-an-evolution-of-data)
  - [17.1. Comma Separated Values (CSV)](#171-comma-separated-values-csv)
  - [17.2. Relational tables definitions](#172-relational-tables-definitions)
  - [17.3. JSON (JavaScript Object Notation)](#173-json-javascript-object-notation)
  - [17.4. Avro](#174-avro)
    - [17.4.1. Avro vs Protobuf vs Thrift vs Parquet vs ORC vs ....](#1741-avro-vs-protobuf-vs-thrift-vs-parquet-vs-orc-vs-)
    - [17.4.2. Primitive Types](#1742-primitive-types)
    - [17.4.3. Record Schemas](#1743-record-schemas)
    - [17.4.4. Complex Types](#1744-complex-types)
    - [17.4.5. Enums](#1745-enums)
    - [17.4.6. Arrays](#1746-arrays)
    - [17.4.7. Maps](#1747-maps)
    - [17.4.8. Unions](#1748-unions)
    - [17.4.9. Logical Types](#1749-logical-types)
...
# 17. An Evolution of data

## 17.1. Comma Separated Values (CSV)
...
## 17.2. Relational tables definitions
...
## 17.3. JSON (JavaScript Object Notation)
...
### 17.4.1. Avro vs Protobuf vs Thrift vs Parquet vs ORC vs ....
