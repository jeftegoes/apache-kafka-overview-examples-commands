...
- [6. Consumers and deserialization](#6-consumers-and-deserialization)
  ...
  - [6.3. Consumer groups and consumer offsets](#63-consumer-groups-and-consumer-offsets)
    - [6.3.1. Consumer groups](#631-consumer-groups)
    - [6.3.2. What if too many consumers?](#632-what-if-too-many-consumers)
...
- [10. Zookeeper](#10-zookeeper)
  - [10.1. Should you use Zookeeper?](#101-should-you-use-zookeeper)
  - [10.2. Kafka KRaft](#102-kafka-kraft)
- [11. Summary](#11-summary)
- [12. Partitions](#12-partitions)
  - [12.1. Partitions count and replication factor](#121-partitions-count-and-replication-factor)
    - [12.1.1. Choosing the partitions count](#1211-choosing-the-partitions-count)
    - [12.1.2. Choosing the replication factor](#1212-choosing-the-replication-factor)
  - [12.2. Cluster guidelines](#122-cluster-guidelines)
  - [12.3. Topic naming conventions](#123-topic-naming-conventions)
- [13. Kafka Connect](#13-kafka-connect)
- [14. Commands](#14-commands)
  - [14.1. Topics commands](#141-topics-commands)
  - [14.2. Producer commands](#142-producer-commands)
  - [14.3. Consumer commands](#143-consumer-commands)
  - [14.4. Consumer groups](#144-consumer-groups)
- [15. Ui Application](#15-ui-application)
- [16. Avro Schema Registry](#16-avro-schema-registry)
- [17. Confluent REST Proxy](#17-confluent-rest-proxy)
...
- A `key` are typically sent if we need message ordering for a specific field (e.g. food_truck_id).
  ![Message keys](/images/kafka-producer-message-keys.png)

## 5.2. Kafka Messages anatomy

- Kafka Message Created by the Producer.
  ![Kafka Messages anatomy](/images/kafka-message-anatomy.png)
...
- **Common serializers**
  ...
  - [Avro](/avro.md).
  - `Protobuf`.
    ![Kafka Message serializer](/images/kafka-message-serializer.png)
...
## 5.5. Sending Message Synchronously

![Sending Message Synchronously](/images/sending-message-synchronously.png)

## 5.6. Sending Message Asynchronously
...
- The serialization / deserialization type must not change during a topic lifecycle (create a new topic instead).
  ![Kafka Message deserializer](/images/kafka-message-deserializer.png)

## 6.3. Consumer groups and consumer offsets

### 6.3.1. Consumer groups
...
- Kafka 3.X now implements the Raft protocol **(KRaft)** in order to replace Zookeeper.
  ![Kafka KRaft Architecture](/images/kafka-kraft-architecture.png)

# 11. Summary

![Summary](images/resume-theory.png)

# 12. Partitions

## 12.1. Partitions count and replication factor
...
### 12.1.1. Choosing the partitions count
...
### 12.1.2. Choosing the replication factor
